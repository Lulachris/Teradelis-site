                ...
                <div class='htmega-flip-box-front'>
                    <div class="front-container">
                        <?php
                            ...
                            if( !empty( $settings['flipbox_front_icon'] ) ){
                                echo '<span class="flipbox-icon"><i class=" '.esc_attr__( $settings['flipbox_front_icon'] ).' "></i></span>';
                            }
                ...
                <div class='htmega-flip-box-back'>
                    <div class="back-container">
                        <?php
                            ...
                            if( !empty( $settings['flipbox_back_icon'] ) ){
                                echo '<span class="flipbox-icon"><i class=" '.esc_attr__( $settings['flipbox_back_icon'] ).' "></i></span>';
                            }

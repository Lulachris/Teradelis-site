                            ...
                            <div class="htmega-hover-action">
                                ...
                                <ul class="htmega-social-network">
                                    <?php foreach ( $settings['htmega_team_member_social_link_list'] as $socialprofile ) :?>
                                        <li class="elementor-repeater-item-<?php echo $socialprofile['_id']; ?>" ><a href="<?php echo esc_url( $socialprofile['htmega_social_link'] ); ?>"><i class="<?php echo esc_attr( $socialprofile['htmega_social_icon'] ); ?>"></i></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>

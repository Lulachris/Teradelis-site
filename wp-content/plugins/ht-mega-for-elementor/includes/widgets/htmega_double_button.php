...
class HTMega_Elementor_Widget_Double_Button extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if ( ! empty( $settings['button_one_link']['url'] ) ) {
            ...
            $button_one_icon  = !empty( $settings['button_one_icon'] ) ? '<span><i class="'.$settings['button_one_icon'].'"></i></span>' : '';
        ...
        $button_two_icon  = !empty( $settings['button_two_icon'] ) ? '<span><i class="'.$settings['button_two_icon'].'"></i></span>' : '';

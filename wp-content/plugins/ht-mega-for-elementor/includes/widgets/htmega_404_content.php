...
class HTMega_Elementor_Widget_ErrorContent extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( !empty( $settings['error_back_button_icon'] ) ){
            $back_button = '<i class="'.$settings['error_back_button_icon'].'"></i> '.$back_button;
        }
        ...
        if( !empty( $settings['error_contact_button_icon'] ) ){
            $contact_button = '<i class="'.$settings['error_contact_button_icon'].'"></i> '.$contact_button;
        }
                            ...
                            <div class="content">
                                <?php
                                    ...
                                    if( !empty( $back_button ) ){
                                        echo sprintf( '<a %1$s>%2$s</a>', $this->get_render_attribute_string( 'backurl' ), $back_button );
                                    }
                                    if( !empty( $contact_button ) ){
                                        echo sprintf( '<a %1$s>%2$s</a>', $this->get_render_attribute_string( 'contacturl' ), $contact_button );
                                    }
                                ?>
                            </div>
                        </div>

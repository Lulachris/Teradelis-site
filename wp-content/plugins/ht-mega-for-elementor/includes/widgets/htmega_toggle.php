...
class HTMega_Elementor_Widget_Toggle extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( !empty( $settings['toggle_button_normal_icon'] ) ){
            $button_normal_txt = $settings['toggle_button_normal_title'].'<i class=" '.$settings['toggle_button_normal_icon'].' "></i>';
        }

        if( !empty( $settings['toggle_button_open_title'] ) ){
            $button_open_txt = $settings['toggle_button_open_title'];
        }
        if( !empty( $settings['toggle_button_open_icon'] ) ){
            $button_open_txt = $settings['toggle_button_open_title'].'<i class=" '.$settings['toggle_button_open_icon'].' "></i>';
        }

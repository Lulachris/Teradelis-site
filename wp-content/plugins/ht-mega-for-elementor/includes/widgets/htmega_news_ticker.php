            ...
            <div <?php echo $this->get_render_attribute_string( 'htmega_newsticker_section_attr' ); ?>>
                    ...
                    <?php
                        if( !empty( $settings['ticker_label'] ) ){
                            if( !empty($settings['label_icon']) ){
                                echo '<h5>'.esc_html__($settings['ticker_label'],'htmega-addons').' <i class="'.esc_attr($settings['label_icon'],'htmega-addons').'"></i></h5>';
                            }else{
                ...
                <?php if( $settings['navigation_show'] == 'yes' ): ?>
                    <div class="breaking-news-nav">
                        <button class="news-ticker-prev"><i class="<?php echo esc_attr__($settings['button_prev_icon'],'htmega-addons');?>"></i></button>
                        <button class="news-ticker-next"><i class="<?php echo esc_attr__($settings['button_next_icon'],'htmega-addons');?>"></i></button>
                    </div>
                <?php endif; ?>

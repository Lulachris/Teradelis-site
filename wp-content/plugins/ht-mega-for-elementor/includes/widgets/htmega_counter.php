        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .htmega-counter-area .htmega-counter-content .htmega-counter-number',
                ]
            );
                ...
                <?php
                    if( $settings['counter_layout_style'] == 6 ){
                        echo '<div class="htmega-counter-icon">';
                            if( isset( $settings['counter_icon'] ) ){
                                echo '<span><i class=" '.esc_attr__( $settings['counter_icon'] ).' "></i></span>';
                            }
                        ...
                        if( isset( $settings['counter_icon'] ) ){
                            echo '<div class="htmega-counter-icon"><span><i class=" '.esc_attr__( $settings['counter_icon'] ).' "></i></span></div>';
                        }
                        if( isset( $settings['counter_image']['url'] ) ){

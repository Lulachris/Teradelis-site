                        ...
                        <a class="htb-nav-link htb-active htb-show" data-toggle="htbtab" href="#switcherone<?php echo $this->get_id(); ?>">
                            <?php
                                if( $settings['switcher_one_icon'] != ''){
                                    echo '<i class="'.esc_attr( $settings['switcher_one_icon'] ).'"></i>'.esc_html__( $settings['switch_one_title'],'htmega-addons' );
                                }else{
                        ...
                        <a class="htb-nav-link" data-toggle="htbtab" href="#switchertwo<?php echo $this->get_id(); ?>">
                            <?php
                                if( $settings['switcher_two_icon'] != ''){
                                    echo '<i class="'.esc_attr( $settings['switcher_two_icon'] ).'"></i>'.esc_html__( $settings['switch_two_title'],'htmega-addons' );
                                }else{

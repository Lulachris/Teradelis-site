        ...
        $this->start_controls_section(
            ...
            $repeater_two->add_control(
                ...
                [
                    ...
                    'default' => __( 'fa fa-shopping-basket', 'htmega-addons' ),
                ]
            );
                ...
                [
                    ...
                    'default' => [
                        [
                            ...
                            'list_cart_icon' => __( 'fa fa-shopping-basket', 'htmega-addons' ),
                        ],
                                ...
                                <div class="price-text-right">
                                    <?php
                                        ...
                                        if( !empty( $pricinglist['list_cart_icon'] ) ){
                                            echo '<span class="basket"><i class=" '.esc_attr__( $pricinglist['list_cart_icon'], 'htmega-addons').' "></i></span>';
                                        }
                                    ?>
                                </div>
                            </a>
                                            ...
                                            if( $settings['datatable_style'] == 2 ){
                                                if( $table_td[$j]['contenttype'] == 'icon' && !empty($table_td[$j]['icon'])){
                                                    ...
                                                    if( !empty( $table_td[$j]['link_url'] ) ){
                                                        echo '<a href=" '.esc_url( $table_td[$j]['link_url'] ).' " '.$table_td[$j]['link_target'].$table_td[$j]['nofollow'].'><span><i class=" '.esc_attr__( $table_td[$j]['icon'],'htmega-addons' ).' "></i></span></a>';
                                                    }else{
                                                        echo '<span><i class=" '.esc_attr__( $table_td[$j]['icon'],'htmega-addons' ).' "></i></span>';
                                                    }
                                                ...
                                                if( $table_td[$j]['contenttype'] == 'icon' ){
                                                    if( !empty( $table_td[$j]['link_url'] ) ){
                                                        echo '<a href=" '.esc_url( $table_td[$j]['link_url'] ).' " '.$table_td[$j]['link_target'].$table_td[$j]['nofollow'].'><i class=" '.esc_attr__( $table_td[$j]['icon'],'htmega-addons' ).' "></i></a>';
                                                    }else{
                                                        echo '<i class=" '.esc_attr__( $table_td[$j]['icon'],'htmega-addons' ).' "></i>';
                                                    }
                                                }else{
                                                    if( !empty( $table_td[$j]['link_url'] ) ){

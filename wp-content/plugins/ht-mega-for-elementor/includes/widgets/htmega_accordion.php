...
class HTMega_Elementor_Widget_Accordion extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( $settings['accordiantstyle'] == 'two' ){
            ...
            $buttonicon = '<i class="accourdion-icon close-accourdion '.$settings['accordion_close_icon'].'"></i><i class="accourdion-icon open-accourdion '.$settings['accordion_open_icon'].'"></i>';

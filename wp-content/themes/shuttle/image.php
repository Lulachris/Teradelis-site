					...
					<header class="entry-header">
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published ', 'shuttle') . '<span><time datetime="%1$s">%2$s</time></span> ' . __( 'at', 'shuttle' ) . ' <a href="%3$s" title="' . esc_attr__( 'Link to full-size image', 'shuttle' ) . '">%4$s &times; %5$s</a> ' . __( 'in', 'shuttle' ) . ' <a href="%6$s" title="' . esc_attr__( 'Return to ', 'shuttle' ) . '%7$s" rel="gallery">%8$s</a>',

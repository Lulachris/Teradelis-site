...
if( class_exists( 'WP_Customize_Control' ) ) {
	class shuttle_customizer_customcontrol_upgrade_inner extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'shuttle-control-upgrade', trailingslashit( get_template_directory_uri() ) . 'admin/main/inc/controls/upgrade_inner/control_upgrade_inner.css', '', time() );
		}
		...
		public function render_content() {
			...
			// -------------------------------------------------------------------------------------
				...
				foreach ( $this->images as $image ) {
					...
					printf(
						'<div class="shuttle-promotion-field-item">

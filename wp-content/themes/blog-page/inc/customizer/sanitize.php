...
if ( ! function_exists( 'blog_page_sanitize_select' ) ) :
	/**
	 ...
	 */
	function blog_page_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'blog_page_sanitize_image' ) ) :
	/**
	 ...
	 */
	function blog_page_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'blog_page_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function blog_page_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'blog_page_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Blog Page 1.0.0
	*/
	function blog_page_sanitize_page( $input ) {
...
if ( ! function_exists( 'blog_page_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Blog Page 1.0.0
	 ...
	 */
	function blog_page_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'blog_page_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Blog Page 1.0.0
	 */
	function blog_page_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'blog_page_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Blog Page 1.0.0
	 */
	function blog_page_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'blog_page_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function blog_page_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function blog_page_sanitize_switch_control( $input ) {
...
* @since Blog Page 1.0.0
*/
function blog_page_sanitize_links( $input ) {
...
* @since Blog Page 1.0.0
*/
function blog_page_sanitize_email( $input ) {

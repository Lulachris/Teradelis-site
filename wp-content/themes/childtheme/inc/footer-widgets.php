...
class Blog_Page_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'blog_page';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'blog-page' ), $i ),
...
// Initialize.
$blog_page_footer_widgets = new Blog_Page_Footer_Widgets();

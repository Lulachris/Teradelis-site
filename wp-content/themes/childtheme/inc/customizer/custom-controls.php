 ...
 */
class Blog_Page_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Blog_Page_Dropdown_Category_Control extends WP_Customize_Control {
...
class Blog_Page_Note_Control extends WP_Customize_Control {
...
class Blog_Page_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Blog_Page_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blog-page-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Blog_Page_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class Blog_Page_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Blog_Page_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
